...
**Bases:** Target path `$BEEWEAVE_VAULT_PATH/_meta/<dashboard-name>.base`

**Dataview:** Write queries directly into any `.md` note. A dedicated dashboard note at `$BEEWEAVE_VAULT_PATH/_meta/dashboard.md` works well for multi-section views.
