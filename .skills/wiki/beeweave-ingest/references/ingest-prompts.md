...
These map onto the Paper Deep-Dive Template in `beeweave-core/SKILL.md`. The goal is a page a reader could study instead of the PDF — figures, equations, and results included.
