...
echo "   2. Start your knowledge flywheel:"
echo ""
echo "      1. Capture knowledge"
echo "         /beeweave-ingest <URL, file, or directory>"
echo ""
echo "      2. Create · Writing flywheel"
echo "         /beeweave-url-capture <URL>"
echo "         /beeweave-article-writer Write an article from the captured source and my vault"
echo "         /beeweave-article-publisher <draft-path>"
echo ""
echo "      Capture → connect → create → publish → distill → create again"
echo ""
echo " Knowledge-only workflows from any other project:"
echo "   /beeweave-ingest    → add files, folders, URLs, or inbox content to your vault"
echo "   /beeweave-update    → sync durable project knowledge to your vault"
echo "   /beeweave-query     → query existing knowledge in your vault"
if $SYNC_CONFIGURED; then
